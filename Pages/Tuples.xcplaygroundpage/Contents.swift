...
// tuples can combine mutiple pieces of data
...
func doSomethingWithUserInfo(info : (name : String, isPremium : Bool, isNew : Bool)) -> Bool {
    return true
}

let info = getUserInfo4()
print(doSomethingWithUserInfo(info : info))
